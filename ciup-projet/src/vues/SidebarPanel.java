...
/**
 * Panneau latיral de l'application
...
public class SidebarPanel extends JPanel {
    ...
    /**
     * Constructeur du panneau latיral
     */
    public SidebarPanel() {
    ...
    /**
     * Crיe un bouton de menu
     * @param text Le texte du bouton
     * @param isActive Si le bouton est actif
     * @return Le bouton crיי
     */
    ...
    /**
     * Dיfinit le bouton actif
     * @param activeButton Le bouton א activer
     */
...
/**
 * cette classe a יtי crיe par @author Flavio Zamperlini
 */