...
/**
 * Panneau d'en-t�te de l'application
...
public class HeaderPanel extends JPanel {
    ...
    /**
     * Constructeur du panneau d'en-t�te
     */
    public HeaderPanel() {
     ...
     * @return L'ic�ne du logo ou null si non trouv�e
     */
    ...
    private void layoutComponents() {
        ...
        JLabel titleLabel = new JLabel("CIT� INTERNATIONALE UNIVERSITAIRE DE PARIS");
